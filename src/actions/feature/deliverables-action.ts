...
export const GETDeliverables = async ({ token }: { token: string }) => {
  try {
    const response = await fetch(`${BASE_URL}/api/deliverables/`, {
      method: "GET",
      headers: {
...
export const GETDeliverablesPublic = async (deliv: number) => {
  try {
    const response = await fetch(`${BASE_URL}/api/deliverables/public-deliverable-info/?deliv=${encodeURIComponent(deliv)}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
      },
...
//metodo de busqueda
export const GETEntregableaSearch = async ({
  token,
  search = "",
}: {
  token: string;
...
export const POSTCreateDeliverables = async (formData: FormData) => {
  try {
    const response = await fetch(`${BASE_URL}/api/deliverables/`, {
      method: "POST",
      headers: {
...
export const PUTDeliverables = async (
  id_deliverable: number,
  token: string,
  ...
  try {
    const response = await fetch(
      `${BASE_URL}/api/deliverables/${id_deliverable}/`,
      {
        method: "PUT",
        headers: {
          "Content-type": "application/json",
...
export const DELETEDeliverables = async (id_deliverable: number, token: string) => {
  try {
    const res = await fetch(`${BASE_URL}/api/deliverables/${id_deliverable}/`, {
      method: "DELETE",
      headers: {
